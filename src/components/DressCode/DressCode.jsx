...
export const DressCode = () => {
	...
	return (
		<section className={styles.container}>
				...
				<p className={styles.text1}>Мы очень старались сделать праздник красивым и гармоничным.<br />Будем благодарны, если вы поддержите стиль и цветовую гамму нашей свадьбы!</p>
				<h3>ЛЕДИ</h3>
