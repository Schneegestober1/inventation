...
export const DressCode = () => {
	...
	return (
		<section className={styles.container}>
				...
				<p>Мы очень старались сделать праздник красивым и гармоничным.Будем благодарны, если вы поддержите стиль и цветовую гамму нашей свадьбы!</p>
				<h3>ЛЕДИ</h3>
				...
				<h3>-ГОРЬКО-</h3>
				<p>Будем благодарны, если вы воздержитесь от частых криков «Горько» и белого цвета в наряде у дам. В белом только невеста!</p>
				<h3>-ПОДАРКИ -</h3>
				<p>Чтобы наши руки были свободны для объятий, мы будем рады легким подаркам в конвертах.</p>
				<h3>-ЦВЕТЫ-</h3>
				<p>Мы знаем, что на свадьбах принято дарить цветы, но мы не успеем насладиться их красотой, ведь они так быстро завянут.</p>
