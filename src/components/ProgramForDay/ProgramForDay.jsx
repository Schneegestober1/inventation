    ...
    <section className={styles.container}>
        ...
        <div className={styles.timelineItems}>
            ...
            <div className={styles.timelineItem}>
                <ImageCard size={150} className={styles.timelineImg} src={'/images/IMG_4337.jpg'} alt='WELCOME' />
            ...
            <div className={styles.timelineItem}>
                <ImageCard size={150} className={styles.timelineImg} src={'/images/IMG_8614.jpg'} alt='WELCOME' />
                <div className={styles.timelineContent}>
            ...
            <div className={styles.timelineItem}>
                <ImageCard size={150} className={styles.timelineImg} src={'/images/IMG_4348.jpg'} alt='WELCOME' />
                <div className={styles.timelineContent}>
            ...
            <div className={styles.timelineItem}>
                <ImageCard size={150} className={styles.timelineImg} src={'/images/IMG_2951.jpg'} alt='WELCOME' />
                <div className={styles.timelineContent}>
            ...
            <div className={styles.timelineItem}>
                <ImageCard size={150} className={styles.timelineImg} src={'/images/Wedding_day.jpg'} alt='WELCOME' />
                <div className={styles.timelineContent}>
